/*  객체(배열) = Object - 자료 묶음 처리 (대량의 데이터 처리)
...
const jsObj1 = [1, 2, 3, "NodeJS", false]; //숫자, 문자열, boolean (""하지않음.)
...
jsObj1.push("HTML", "CSS", true, 11111);
console.log("객체의 마지막 요소 추가 :" + jsObj1);
console.log("");
console.log("--------------------------------------------------------");
...
/* 객체명.sort(): 정렬 */
const jsObj2 = [5, 1, 3, 2, 4];
jsObj2.splice(2, 2); //2번째 부터 2개 제거
console.log(jsObj2.sort()); // sort 정렬
console.log("");
console.log("--------------------------------------------------------");
